            ...
            if (!context.Articles.Any())
            {
                ...
                var articles = new Article[]
                {
                    new Article
                    {
                        ...
                        TopicId = basketballTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2019, 7, 24, 17, 45, 0)
                    },
                    new Article
                    {
                        Title = "Jordan Killganon has become champion of Dank King Season 2!",
                        Rating = 39,
                        Overview = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore " +
                                   "et dolore magna aliqua. Enim nulla aliquet porttitor lacus luctus accumsan tortor. Risus at ultrices mi " +
                                   "tempus imperdiet. Eget gravida cum sociis natoque penatibus et magnis dis parturient. Metus dictum at " +
                        ...
                        Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et " +
                                    ...
                                    "nullam vehicula. Turpis egestas pretium aenean pharetra magna ac placerat vestibulum. Purus viverra " +
                                    "accumsan in nisl. Lorem sed risus ultricies tristique nulla.",
                        Tags="#dankking#danks#killganon#champion",
                        TopicId = basketballTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2018, 5, 12, 19, 12, 0)
                    },
                    new Article
                    {
                        ...
                        TopicId = basketballTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2020, 3, 17, 13, 21, 0)
                    },
                    new Article
                    {
                        ...
                        TopicId = itTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2019, 5, 17, 13, 21, 0)
                    },
                    new Article
                    {
                        ...
                        TopicId = itTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2019, 9, 22, 17, 21, 0)
                    },
                    new Article
                    {
                        ...
                        TopicId = itTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2019, 9, 22, 17, 28, 0)
                    },
                    new Article
                    {
                        ...
                        TopicId = itTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2019, 4, 22, 17, 22, 0)
                    },
                    new Article
                    {
                        ...
                        TopicId = businessTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2019, 6, 18, 17, 22, 0)
                    },
                     new Article
                    {
                        ...
                        TopicId = businessTopic.Id,
                        WriterId = user.Writer.Id,
                        PublichDate = new System.DateTime(2020, 9, 28, 21, 52, 0)
                    }
                };
            ...
            if (!context.Comments.Any())
            {
                ...
                var comments = new Comment[]
                {
                    new Comment
                    {
                        ...
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2019, 8, 12, 19, 5, 0)
                    },
                    new Comment
                    {
                        Rating = 2,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2020, 8, 4, 18, 11, 0)
                    },
                    new Comment
                    {
                        Rating = 0,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2019, 12, 25, 11, 2, 0)
                    },
                    new Comment
                    {
                        Rating = 22,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2020, 3, 17, 17, 5, 0)
                    },
                    new Comment
                    {
                        Rating = -1,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2019, 10, 12, 22, 51, 0)
                    },
                    new Comment
                    {
                        Rating = 4,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2019, 8, 22, 11, 15, 0)
                    },
                    new Comment
                    {
                        Rating = 0,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2019, 8, 12, 19, 45, 0)
                    },
                    new Comment
                    {
                        Rating = -11,
                        ...
                        ArticleId = article.Id,
                        ReviewerId = user.Id,
                        PublichDate = new DateTime(2019, 11, 12, 19, 5, 0)
                    },
                    new Comment
                    {
                        Rating = 8,
